...
class Kmer_Dict:
    ...
    def get_primers(self):
        ...
        for key1 in self.dict.keys():
            ...
            merged_primer_dict[key1] = primer_dict

        return merged_primer_dict
    ...
    def check_primers(self, primer_dict):
        ...
        for key1 in primer_dict.keys():
            sample_primers = primer_dict[key1]

            for key2 in list(sample_primers.keys()):
                for_rev_primers = sample_primers[key2]

                for key3 in list(for_rev_primers.keys()):

                    kmer = for_rev_primers[key3]
                    good_primer = True
                    ...
                    while position < (len(kmer) - 2):
                        sub_kmer_1 = kmer[position:(position + 3)]
                        sub_kmer_2 = kmer[::-1][position:(position + 3)]
                        sub_kmers.append(sub_kmer_1)
                        rev_kmers.append(sub_kmer_2)
                        position += 1
                    ...
                    for kmer1 in sub_kmers:
                        ...
                        if good_primer == False:
                            del primer_dict[key1][key2][key3]
                            break
